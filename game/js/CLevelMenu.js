function CLevelMenu(){
	...
	_pStartPosExit = {x:CANVAS_WIDTH - (oSprite.width/2) - 10,y:(oSprite.height/2) + 10};
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x: oSprite.width/4 + 9,y:(oSprite.height/2)+10};
        ...
        _pStartPosSelect = {x:CANVAS_WIDTH/2,y:_aContainerPage[0].y - _aContainerPage[0].getBounds().height/2 -60};       
        var iWidth = 500;
        var iHeight = 50;
