<?php
    /*
    Plugin Name: CTL Arcade - Mahjong Deluxe
    Plugin URI: http://www.codethislab.com/
    Description: Mahjong Deluxe for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeMahjongDeluxe{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-mahjong-deluxe";
        private $_szPluginName              = "Mahjong Deluxe";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "board game, card, cards, html5 mahjong, mahjong, mobile, puzzle, tile,logic, solitaire, solitaire game, chinese game, card game,html5 solitaire, html5 board game";
    ...
    $g_oCTLArcadeMahjongDeluxe =  new CTLArcadeMahjongDeluxe();
